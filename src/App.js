      ...
      <>
        <header id="navbarHeader" className="navbar navbar-dark bg-dark box-shadow">
          <div className="container d-flex justify-content-between">
            ...
            <a href="https://github.com/zhisme" className="header-link">
        ...
        <main role="main">
          <section className="jumbotron text-center">
            <div className="container">
              <h1 class="jumbotron-heading">WoW Burning Crusade AEP calculator</h1>
              <p className="lead text-muted">
                This AEP calculator took its idea from <a href="https://silentshadows.net/rogue-stat-weights-aep-values/"> rogues fan site </a><br/>
